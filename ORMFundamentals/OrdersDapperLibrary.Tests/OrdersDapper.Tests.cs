...
using OrdersDapper.Library;

namespace OrdersDapperLibrary.Tests
{
    public class OrdersTests : IDisposable
    {
        ...
        public void Update_ReturnsUpdatedOrder()
        {
            ...
            Assert.Equal(DateTime.Parse(orderToUpdate.CreatedDate.ToString("yyyy-MM-dd hh:mm:ss.000")), DateTime.Parse(result.CreatedDate.ToString("yyyy-MM-dd hh:mm:ss.000")));
            Assert.Equal(DateTime.Parse(orderToUpdate.UpdatedDate.ToString("yyyy-MM-dd hh:mm:ss.000")), DateTime.Parse(result.UpdatedDate.ToString("yyyy-MM-dd hh:mm:ss.000")));
